...
<img src={logo} alt="Logo du site" style={{ width: 90, height: 90 }} />
	...
	{user && (
		...
		{/* Bouton Admin visible seulement si le rôle est 'admin' */}
		{role === 'admin' && (
			<button
			className="admin-btn"
			style={{marginLeft: 10, padding: '6px 16px', borderRadius: '20px', border: 'none', background: '#d1e7dd', cursor: 'pointer', fontWeight: 'bold', color: '#0a6847'}}
